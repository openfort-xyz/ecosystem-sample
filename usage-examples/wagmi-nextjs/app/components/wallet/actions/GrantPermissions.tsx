...
export function GrantPermissionAction() {
  ...
  if (sessionError) {
    return (
      <div className="bg-white rounded-lg shadow-sm border border-red-200 p-6 w-[500px]">
    ...
    <div 
      ...
      title={
        accountStatus === 'disconnected'
          ? 'Connect your wallet to grant permissions'
          : ''
      }
    >
      {/* Header */}
      ...
      >
        {accountStatus === 'disconnected' ? (
          ...
          <>
            Grant {selectedTier.name} Permissions
          </>
        )}
      </button>
    </div>
