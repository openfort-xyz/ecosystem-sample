/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0708ee3f192a3523818103e1c8b3ae85)
// Runtime types generated with workerd@1.20251118.0 2025-11-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		OPENFORT_PUBLIC_KEY: string;
		PORT: string;
		SHIELD_PROD_PUBLIC_KEY: string;
		SHIELD_PUBLIC_KEY: string;
		COINBASE_KEY_ID: string;
		COINBASE_KEY_SECRET: string;
		ENCRYPTION_PROD_SHARE: string;
		ENCRYPTION_SHARE: string;
		OPENFORT_PROD_SECRET_KEY: string;
		OPENFORT_SECRET_KEY: string;
		SHIELD_PROD_SECRET_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENFORT_PUBLIC_KEY" | "PORT" | "SHIELD_PROD_PUBLIC_KEY" | "SHIELD_PUBLIC_KEY" | "COINBASE_KEY_ID" | "COINBASE_KEY_SECRET" | "ENCRYPTION_PROD_SHARE" | "ENCRYPTION_SHARE" | "OPENFORT_PROD_SECRET_KEY" | "OPENFORT_SECRET_KEY" | "SHIELD_PROD_SECRET_KEY" | "SHIELD_SECRET_KEY" | "STRIPE_SECRET_KEY">> {}
}
